    ...
    var map = new ol.Map({
		...
		new ol.layer.Image({
		 ...
		 source: new ol.source.ImageWMS({
		   ...
		   crossOrigin: 'anonymous',
		   params: {
			 'SLD': 'https://github.com/jventin/jventin.github.io/blob/master/sld/taustakartta_4000k.sld',
			 'FORMAT': 'image/png'
		   },
		   serverType: /** @type {ol.source.wms.ServerType} */ ('geoserver')
		 }),
		...
		new ol.layer.Image({
		 ...
		 source: new ol.source.ImageWMS({
		   ...
		   crossOrigin: 'anonymous',
		   params: {
			 'SLD': 'http://avoindata.maanmittauslaitos.fi/sld/taustakartta_2000k.sld',
			 'FORMAT': 'image/png'
		   },
		   serverType: /** @type {ol.source.wms.ServerType} */ ('geoserver')
		 }),
		...
		new ol.layer.Image({
		 ...
		 source: new ol.source.ImageWMS({
		   ...
		   crossOrigin: 'anonymous',
		   params: {
			 'SLD': 'http://avoindata.maanmittauslaitos.fi/sld/taustakartta_800k.sld',
			 'FORMAT': 'image/png'
		   },
		   serverType: /** @type {ol.source.wms.ServerType} */ ('geoserver')
		 }),
		...
		new ol.layer.Image({
		 ...
		 source: new ol.source.ImageWMS({
		   ...
		   crossOrigin: 'anonymous',
		   params: {
			 'SLD': 'http://avoindata.maanmittauslaitos.fi/sld/taustakartta_320k.sld',
			 'FORMAT': 'image/png'
		   },
		   serverType: /** @type {ol.source.wms.ServerType} */ ('geoserver')
		 }),
